...
vim.api.nvim_set_hl(0, "BufferLineWarningSelected", { bg = "NONE", fg = "#d9b27c", bold = true })
vim.api.nvim_set_hl(0, "BufferLineErrorSelected", { bg = "NONE", fg = "#c65f5f", bold = true })
...
-- vim.api.nvim_set_hl(0, "BufferLineWarning", { bg = "none" })
-- vim.api.nvim_set_hl(0, "BufferLineBufferBackground", { bg = "none" })
-- vim.api.nvim_set_hl(0, "BufferLineDevIconLua", { bg = "none", fg = "none" })
-- vim.api.nvim_set_hl(0, "BufferLineDevIconDefault", { bg = "none", fg = "none" })
